$(function () {
    ...
    bar += '            <a class="btn mt-2 ' + (window.location.href.indexOf("FieldMapping.html") > -1 ? "neon-button" : "btn-primary") + '" href="../../Content/Hybris/FieldMapping.html">Field Mapping & Data Mapper</a>';
