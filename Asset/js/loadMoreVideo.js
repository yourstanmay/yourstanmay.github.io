const videos = [
  ...
  {
    title:
      "Cart Customization in SAP Commerce | CartEntryMergeFilter | CustomCartParameterPopulator | Hooks",
    src: "https://www.youtube.com/embed/BLHw63WRbQg?si=XCfhAXTeAWeNNHAl?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Myntra Clone Using SAP Commerce (Hybris) 2211 JDK 21 | Spartacus | Project Demo",
    src: "https://www.youtube.com/embed/5NNzxmFsoIc?si=Acv6eVplqhDYBQJt?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "B2B Spartacus Storefront Setup | SAP Commerce Cloud 2211JDK21 | Hybris | Powertools SPA (Composable)",
    src: "https://www.youtube.com/embed/jcQ-u3-nLBQ?si=h8fDJoBE79j2kQAI?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Sap Commerce Cloud (Hybris) 2211 JDK21 With Spartacus Setup | Spartacus",
    src: "https://www.youtube.com/embed/iAAhBrRsR3A?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Flexible Search Queries in SAP Commerce (Hybris) | Beginner to Advanced",
    src: "https://www.youtube.com/embed/40GxuH2Hi_8?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Impex in SAP Hybris | Insert | Update | Remove | Export | SAP Commerce CX | Tutorial",
    src: "https://www.youtube.com/embed/ePdhMMfnNb4?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Create Custom Page From SmartEdit In SAP Hybris | Adding Custom Page in Navigation Node | WCMS",
    src: "https://www.youtube.com/embed/PyHisY7bHkM?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Unable to login Smart Edit | SAP Commerce | Resolve Smart Edit Login Issue",
  ...
  {
    title:
      "Solr in SAP Hybris | Facet | Create Custom Value Provider | Indexing | Searching | SAP Commerce",
    src: "https://www.youtube.com/embed/J9yMb9Cjg6s?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Creating Persistence Hooks for Integration Objects in SAP Hybris | SAP Commerce | PrePersistHook",
    src: "https://www.youtube.com/embed/Qc3K4UcquA4?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Integration in SAP Hybris | SAP Commerce | Integration Object Modeling | Integration UI Tool",
    src: "https://www.youtube.com/embed/hf8-Gno2vHQ?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "How to Send Emails in SAP Commerce | A Step-by-Step Guide to Sending Emails with SAP Hybris",
  ...
  {
    title:
      "Custom API | OCC | DTO Mapping | Different Layers in SAP Hybris (Controller, Facades, Service, Dao)",
    src: "https://www.youtube.com/embed/UzNSjUOs4kI?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "SAP Hybris Backoffice Customization (Part-2)| Advance Search, Filter tree, Column Header & Many more",
    src: "https://www.youtube.com/embed/VJQyg5VxaDI?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Install Temporary License in SAP Hybris | Hybris 30 days license expired | Wrapper Stopped issue",
    src: "https://www.youtube.com/embed/gwoF6BhEWSA?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Data Modeling | Dynamic Attributes| Interceptor in SAP Hybris | SAP Commerce",
    src: "https://www.youtube.com/embed/-mfUh6uKsRA?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "Create Custom Extension in Hybris | Debug Configuration | Code Setup in Intellij | SAP Hybris",
    src: "https://www.youtube.com/embed/zEWLnN-r0As?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "SAP Hybris2205 With Spartacus Complete Setup | SAP Commerce | Spartacus",
    src: "https://www.youtube.com/embed/Q-hRpJXowv4?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "SAP Hybris Backoffice Customization | Customize Backoffice Theme, Logo and Avatar in SAP commerce",
    src: "https://www.youtube.com/embed/56fkbFF3mAk?origin=https://yourstanmay.github.io",
  },
  {
    title:
      "SAP Hybris Core | Data Modeling | Product Modeling | Dynamic Attributes | Impex | Use Case Activity",
  ...
  {
    title:
      "MountBlue Technologies HackerRank Sample Exam | Odd Number| Find the Number | Solution",
...
function loadVideos() {
  try {
    ...
    if (!videoContainer || !videoCount) {
      console.error(
        "Required elements not found: video-container or video-count",
      );
      return;
    }
    ...
    if (loadMoreButton) {
      loadMoreButton.style.display =
        end >= filteredVideos.length ? "none" : "block";
    }
  } catch (error) {
