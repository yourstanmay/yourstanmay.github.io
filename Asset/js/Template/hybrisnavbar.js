$(function () {
    ...
    bar += '            <a class="btn mt-2 ' + (window.location.href.indexOf("Hybris2211_JDK21_SPA_Setup.html") > -1 ? "neon-button" : "btn-primary") + '" href="../../Content/Hybris/Hybris2211_JDK21_SPA_Setup.html">Hybris2211JDK21 Spartacus Setup</a>';
    ...
    bar += '            <a class="btn mt-2 ' + (window.location.href.indexOf("CustomFieldMapping.html") > -1 ? "neon-button" : "btn-primary") + '" href="../../Content/Hybris/CustomFieldMapping.html">Custom Field Mapping</a>';
